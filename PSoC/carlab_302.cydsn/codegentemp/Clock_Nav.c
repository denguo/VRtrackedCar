...
void Clock_Nav_Start(void) 
{
    ...
    Clock_Nav_CLKEN |= Clock_Nav_CLKEN_MASK;
}


/*******************************************************************************
* Function Name: Clock_Nav_Stop
********************************************************************************
* Summary:
...
/*******************************************************************************
* Function Name: Clock_Nav_StopBlock
********************************************************************************
* Summary:
...
{
    if (Clock_Nav_CLKEN & Clock_Nav_CLKEN_MASK)
    {
        ...
        CLK_DIST_AMASK = Clock_Nav_CLKEN_MASK;
        CLK_DIST_DMASK = 0x00u;
#else
        CLK_DIST_DMASK = Clock_Nav_CLKEN_MASK;
        ...
        oldDivider = CY_GET_REG16(Clock_Nav_DIV_PTR);
        ...
        CLK_DIST_LD = 0x00u;
        CY_SET_REG16(Clock_Nav_DIV_PTR, oldDivider);
#endif
    }
}
#endif
...
/*******************************************************************************
* Function Name: Clock_Nav_StandbyPower
********************************************************************************
* Summary:
...
void Clock_Nav_StandbyPower(uint8 state) 
{
    if(state == 0)
    {
        Clock_Nav_CLKSTBY &= ~Clock_Nav_CLKSTBY_MASK;
    }
    else
    {
        Clock_Nav_CLKSTBY |= Clock_Nav_CLKSTBY_MASK;
...
/*******************************************************************************
* Function Name: Clock_Nav_SetDividerRegister
********************************************************************************
* Summary:
...
*
*******************************************************************************/
void Clock_Nav_SetDividerRegister(uint16 clkDivider, uint8 restart) 
{
    uint8 enabled;

    uint8 currSrc = Clock_Nav_GetSourceRegister();
    uint16 oldDivider = Clock_Nav_GetDividerRegister();

    if (clkDivider != oldDivider)
    {
        enabled = Clock_Nav_CLKEN & Clock_Nav_CLKEN_MASK;
        ...
        if (currSrc == CYCLK_SRC_SEL_CLK_SYNC_D && (oldDivider == 0 || clkDivider == 0))
        {
            ...
            if (oldDivider == 0 && clkDivider != 0)
            {
                ...
                CY_SET_REG16(Clock_Nav_DIV_PTR, clkDivider);
                Clock_Nav_MOD_SRC &= ~CYCLK_SSS;
            }
            else
            {
...
/*******************************************************************************
* Function Name: Clock_Nav_GetDividerRegister
********************************************************************************
* Summary:
...
{
    return CY_GET_REG16(Clock_Nav_DIV_PTR);
}


/*******************************************************************************
* Function Name: Clock_Nav_SetModeRegister
********************************************************************************
* Summary:
...
*
*******************************************************************************/
void Clock_Nav_SetModeRegister(uint8 clkMode) 
{
    Clock_Nav_MOD_SRC |= clkMode & Clock_Nav_MODE_MASK;
}


/*******************************************************************************
* Function Name: Clock_Nav_ClearModeRegister
********************************************************************************
* Summary:
...
*
*******************************************************************************/
void Clock_Nav_ClearModeRegister(uint8 clkMode) 
{
    Clock_Nav_MOD_SRC &= ~clkMode | ~Clock_Nav_MODE_MASK;
}
...
/*******************************************************************************
* Function Name: Clock_Nav_GetModeRegister
********************************************************************************
* Summary:
...
{
    return Clock_Nav_MOD_SRC & Clock_Nav_MODE_MASK;
}


/*******************************************************************************
* Function Name: Clock_Nav_SetSourceRegister
********************************************************************************
* Summary:
...
{
    uint16 currDiv = Clock_Nav_GetDividerRegister();
    uint8 oldSrc = Clock_Nav_GetSourceRegister();
    ...
    if (oldSrc != CYCLK_SRC_SEL_CLK_SYNC_D && clkSource == CYCLK_SRC_SEL_CLK_SYNC_D && currDiv == 0)
    {
        ...
        Clock_Nav_MOD_SRC |= CYCLK_SSS;
        Clock_Nav_MOD_SRC =
            (Clock_Nav_MOD_SRC & ~Clock_Nav_SRC_SEL_MSK) | clkSource;
    }
...
/*******************************************************************************
* Function Name: Clock_Nav_GetSourceRegister
********************************************************************************
* Summary:
...
{
    return Clock_Nav_MOD_SRC & Clock_Nav_SRC_SEL_MSK;
}
...
/*******************************************************************************
* Function Name: Clock_Nav_SetPhaseRegister
********************************************************************************
* Summary:
...
{
    Clock_Nav_PHASE = clkPhase & Clock_Nav_PHASE_MASK;
}


/*******************************************************************************
* Function Name: Clock_Nav_GetPhase
********************************************************************************
* Summary:
...
{
    return Clock_Nav_PHASE & Clock_Nav_PHASE_MASK;
}
