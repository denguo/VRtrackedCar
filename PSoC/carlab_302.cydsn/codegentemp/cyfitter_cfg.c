...
#define CY_CFG_BASE_ADDR_COUNT 36
typedef struct
{
	uint8 offset;
	uint8 value;
...
#define cy_cfg_data_table ((const cy_cfg_addrvalue_t CYFAR *)0x48000090)

/* IDMUX_IRQ Address: CYREG_IDMUX_IRQ_CTL0 Size (bytes): 8 */
#define BS_IDMUX_IRQ_VAL ((const uint8 CYFAR *)0x48000D34)

/* IOPINS0_2 Address: CYREG_PRT2_DM0 Size (bytes): 8 */
#define BS_IOPINS0_2_VAL ((const uint8 CYFAR *)0x48000D3C)

/* IOPINS0_4 Address: CYREG_PRT4_DM0 Size (bytes): 8 */
#define BS_IOPINS0_4_VAL ((const uint8 CYFAR *)0x48000D44)

/* IOPINS0_5 Address: CYREG_PRT5_DR Size (bytes): 10 */
#define BS_IOPINS0_5_VAL ((const uint8 CYFAR *)0x48000D4C)
...
static void ClockSetup(void)
{
	...
	CY_SET_XTND_REG24((void CYFAR *)(CYREG_CLKDIST_DCFG2_CFG0), 0x18004D);
	CY_SET_XTND_REG24((void CYFAR *)(CYREG_CLKDIST_DCFG3_CFG0), 0x19001D);
	CY_SET_XTND_REG24((void CYFAR *)(CYREG_CLKDIST_DCFG4_CFG0), 0x19012B);
...
void cyfitter_cfg(void)
{
	...
	CY_SET_XTND_REG8(CYREG_MLOGIC_DEBUG, (CY_GET_XTND_REG8(CYREG_MLOGIC_DEBUG) | 0x04));

	{
		...
		for (i = 0; i < CFG_MEMCPY_COUNT; i++)
		{
			...
			const void * CYDATA src = mc->src;
			uint16 CYDATA size = mc->size;
			CYCONFIGCPY(dest, src, size);
		}
