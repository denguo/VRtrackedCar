// ======================================================================
// carlab_302.v generated from TopDesign.cysch
// 05/12/2017 at 03:04
...
module CharLCD_v1_70_1 ;
	...
	cy_psoc3_pins_v1_10
		#(.id("ab1ae047-9a92-425e-ae3d-c73023921dcb/ed092b9b-d398-4703-be89-cebf998501f6"),
...
// Timer_v2_30(CaptureAlternatingFall=false, CaptureAlternatingRise=false, CaptureCount=2, CaptureCounterEnabled=false, CaptureInputEnabled=true, CaptureMode=1, CONTROL3=1, ControlRegRemoved=0, CtlModeReplacementString=SyncCtl, CyGetRegReplacementString=CY_GET_REG16, CySetRegReplacementString=CY_SET_REG16, DeviceFamily=PSoC5, EnableMode=0, FF16=true, FF8=false, FixedFunction=true, FixedFunctionUsed=1, HWCaptureCounterEnabled=false, InterruptOnCapture=true, InterruptOnFIFOFull=false, InterruptOnTC=false, IntOnCapture=1, IntOnFIFOFull=0, IntOnTC=0, NumberOfCaptures=1, param45=1, Period=65535, RegDefReplacementString=reg16, RegSizeReplacementString=uint16, Resolution=16, RstStatusReplacementString=rstSts, RunMode=0, SiliconRevision=0, SoftwareCaptureModeEnabled=false, SoftwareTriggerModeEnabled=false, TriggerInputEnabled=false, TriggerMode=0, UDB16=false, UDB24=false, UDB32=false, UDB8=false, UDBControlReg=false, UsesHWEnable=0, VerilogSectionReplacementString=sT16, CY_COMPONENT_NAME=Timer_v2_30, CY_CONTROL_FILE=<:default:>, CY_FITTER_NAME=Timer_HE, CY_INSTANCE_SHORT_NAME=Timer_HE, CY_MAJOR_VERSION=2, CY_MINOR_VERSION=30, CY_REMOVE=false, CY_SUPPRESS_API_GEN=false, CY_VERSION=cydsfit No Version Information Found, INSTANCE_NAME=Timer_HE, )
module Timer_v2_30_2 (
    clock,
    reset,
    interrupt,
    enable,
...
// Timer_v2_30(CaptureAlternatingFall=false, CaptureAlternatingRise=false, CaptureCount=2, CaptureCounterEnabled=false, CaptureInputEnabled=true, CaptureMode=1, CONTROL3=1, ControlRegRemoved=0, CtlModeReplacementString=SyncCtl, CyGetRegReplacementString=CY_GET_REG16, CySetRegReplacementString=CY_SET_REG16, DeviceFamily=PSoC5, EnableMode=0, FF16=true, FF8=false, FixedFunction=true, FixedFunctionUsed=1, HWCaptureCounterEnabled=false, InterruptOnCapture=true, InterruptOnFIFOFull=false, InterruptOnTC=false, IntOnCapture=1, IntOnFIFOFull=0, IntOnTC=0, NumberOfCaptures=1, param45=1, Period=65535, RegDefReplacementString=reg16, RegSizeReplacementString=uint16, Resolution=16, RstStatusReplacementString=rstSts, RunMode=0, SiliconRevision=0, SoftwareCaptureModeEnabled=false, SoftwareTriggerModeEnabled=false, TriggerInputEnabled=false, TriggerMode=0, UDB16=false, UDB24=false, UDB32=false, UDB8=false, UDBControlReg=false, UsesHWEnable=0, VerilogSectionReplacementString=sT16, CY_COMPONENT_NAME=Timer_v2_30, CY_CONTROL_FILE=<:default:>, CY_FITTER_NAME=Timer_Nav, CY_INSTANCE_SHORT_NAME=Timer_Nav, CY_MAJOR_VERSION=2, CY_MINOR_VERSION=30, CY_REMOVE=false, CY_SUPPRESS_API_GEN=false, CY_VERSION=cydsfit No Version Information Found, INSTANCE_NAME=Timer_Nav, )
...
// Timer_v2_30(CaptureAlternatingFall=false, CaptureAlternatingRise=false, CaptureCount=2, CaptureCounterEnabled=false, CaptureInputEnabled=true, CaptureMode=3, CONTROL3=0, ControlRegRemoved=0, CtlModeReplacementString=SyncCtl, CyGetRegReplacementString=CY_GET_REG24, CySetRegReplacementString=CY_SET_REG24, DeviceFamily=PSoC5, EnableMode=0, FF16=false, FF8=false, FixedFunction=false, FixedFunctionUsed=0, HWCaptureCounterEnabled=false, InterruptOnCapture=true, InterruptOnFIFOFull=false, InterruptOnTC=false, IntOnCapture=1, IntOnFIFOFull=0, IntOnTC=0, NumberOfCaptures=1, param45=1, Period=16777215, RegDefReplacementString=reg32, RegSizeReplacementString=uint32, Resolution=24, RstStatusReplacementString=rstSts, RunMode=0, SiliconRevision=0, SoftwareCaptureModeEnabled=false, SoftwareTriggerModeEnabled=false, TriggerInputEnabled=false, TriggerMode=0, UDB16=false, UDB24=true, UDB32=false, UDB8=false, UDBControlReg=true, UsesHWEnable=0, VerilogSectionReplacementString=sT24, CY_COMPONENT_NAME=Timer_v2_30, CY_CONTROL_FILE=<:default:>, CY_FITTER_NAME=Timer_Infrared_0, CY_INSTANCE_SHORT_NAME=Timer_Infrared_0, CY_MAJOR_VERSION=2, CY_MINOR_VERSION=30, CY_REMOVE=false, CY_SUPPRESS_API_GEN=false, CY_VERSION=cydsfit No Version Information Found, INSTANCE_NAME=Timer_Infrared_0, )
...
// Timer_v2_30(CaptureAlternatingFall=false, CaptureAlternatingRise=false, CaptureCount=2, CaptureCounterEnabled=false, CaptureInputEnabled=true, CaptureMode=3, CONTROL3=0, ControlRegRemoved=0, CtlModeReplacementString=SyncCtl, CyGetRegReplacementString=CY_GET_REG24, CySetRegReplacementString=CY_SET_REG24, DeviceFamily=PSoC5, EnableMode=0, FF16=false, FF8=false, FixedFunction=false, FixedFunctionUsed=0, HWCaptureCounterEnabled=false, InterruptOnCapture=true, InterruptOnFIFOFull=false, InterruptOnTC=false, IntOnCapture=1, IntOnFIFOFull=0, IntOnTC=0, NumberOfCaptures=1, param45=1, Period=16777215, RegDefReplacementString=reg32, RegSizeReplacementString=uint32, Resolution=24, RstStatusReplacementString=rstSts, RunMode=0, SiliconRevision=0, SoftwareCaptureModeEnabled=false, SoftwareTriggerModeEnabled=false, TriggerInputEnabled=false, TriggerMode=0, UDB16=false, UDB24=true, UDB32=false, UDB8=false, UDBControlReg=true, UsesHWEnable=0, VerilogSectionReplacementString=sT24, CY_COMPONENT_NAME=Timer_v2_30, CY_CONTROL_FILE=<:default:>, CY_FITTER_NAME=Timer_Infrared_1, CY_INSTANCE_SHORT_NAME=Timer_Infrared_1, CY_MAJOR_VERSION=2, CY_MINOR_VERSION=30, CY_REMOVE=false, CY_SUPPRESS_API_GEN=false, CY_VERSION=cydsfit No Version Information Found, INSTANCE_NAME=Timer_Infrared_1, )
...
// Timer_v2_30(CaptureAlternatingFall=false, CaptureAlternatingRise=false, CaptureCount=2, CaptureCounterEnabled=false, CaptureInputEnabled=true, CaptureMode=3, CONTROL3=0, ControlRegRemoved=0, CtlModeReplacementString=SyncCtl, CyGetRegReplacementString=CY_GET_REG24, CySetRegReplacementString=CY_SET_REG24, DeviceFamily=PSoC5, EnableMode=0, FF16=false, FF8=false, FixedFunction=false, FixedFunctionUsed=0, HWCaptureCounterEnabled=false, InterruptOnCapture=true, InterruptOnFIFOFull=false, InterruptOnTC=false, IntOnCapture=1, IntOnFIFOFull=0, IntOnTC=0, NumberOfCaptures=1, param45=1, Period=16777215, RegDefReplacementString=reg32, RegSizeReplacementString=uint32, Resolution=24, RstStatusReplacementString=rstSts, RunMode=0, SiliconRevision=0, SoftwareCaptureModeEnabled=false, SoftwareTriggerModeEnabled=false, TriggerInputEnabled=false, TriggerMode=0, UDB16=false, UDB24=true, UDB32=false, UDB8=false, UDBControlReg=true, UsesHWEnable=0, VerilogSectionReplacementString=sT24, CY_COMPONENT_NAME=Timer_v2_30, CY_CONTROL_FILE=<:default:>, CY_FITTER_NAME=Timer_Infrared_2, CY_INSTANCE_SHORT_NAME=Timer_Infrared_2, CY_MAJOR_VERSION=2, CY_MINOR_VERSION=30, CY_REMOVE=false, CY_SUPPRESS_API_GEN=false, CY_VERSION=cydsfit No Version Information Found, INSTANCE_NAME=Timer_Infrared_2, )
...
// Timer_v2_30(CaptureAlternatingFall=false, CaptureAlternatingRise=false, CaptureCount=2, CaptureCounterEnabled=false, CaptureInputEnabled=true, CaptureMode=3, CONTROL3=0, ControlRegRemoved=0, CtlModeReplacementString=SyncCtl, CyGetRegReplacementString=CY_GET_REG24, CySetRegReplacementString=CY_SET_REG24, DeviceFamily=PSoC5, EnableMode=0, FF16=false, FF8=false, FixedFunction=false, FixedFunctionUsed=0, HWCaptureCounterEnabled=false, InterruptOnCapture=true, InterruptOnFIFOFull=false, InterruptOnTC=false, IntOnCapture=1, IntOnFIFOFull=0, IntOnTC=0, NumberOfCaptures=1, param45=1, Period=16777215, RegDefReplacementString=reg32, RegSizeReplacementString=uint32, Resolution=24, RstStatusReplacementString=rstSts, RunMode=0, SiliconRevision=0, SoftwareCaptureModeEnabled=false, SoftwareTriggerModeEnabled=false, TriggerInputEnabled=false, TriggerMode=0, UDB16=false, UDB24=true, UDB32=false, UDB8=false, UDBControlReg=true, UsesHWEnable=0, VerilogSectionReplacementString=sT24, CY_COMPONENT_NAME=Timer_v2_30, CY_CONTROL_FILE=<:default:>, CY_FITTER_NAME=Timer_Infrared_3, CY_INSTANCE_SHORT_NAME=Timer_Infrared_3, CY_MAJOR_VERSION=2, CY_MINOR_VERSION=30, CY_REMOVE=false, CY_SUPPRESS_API_GEN=false, CY_VERSION=cydsfit No Version Information Found, INSTANCE_NAME=Timer_Infrared_3, )
...
module top ;
	...
	cy_clock_v1_0
		#(.id("32371878-841d-4b15-986a-ac1689b16d0e"),
		  .source_clock_id(""),
		  .divisor(0),
		  .period("100000000000"),
		  .is_direct(0),
    ...
    Timer_v2_30_2 Timer_HE (
        ...
        .tc(Net_150),
        .clock(Net_17));
    defparam Timer_HE.CaptureCount = 2;
    defparam Timer_HE.CaptureCounterEnabled = 0;
    defparam Timer_HE.DeviceFamily = "PSoC5";
    defparam Timer_HE.InterruptOnCapture = 1;
    defparam Timer_HE.InterruptOnTC = 0;
    defparam Timer_HE.Resolution = 16;
    defparam Timer_HE.SiliconRevision = "0";
    ...
    UART_v2_20_3 UART (
        ...
        .reset(1'b0),
        .rx(Net_461),
        .tx_interrupt(Net_727),
        .rx_interrupt(Net_802),
        .tx_data(Net_729),
        .tx_clk(Net_730),
        .rx_data(Net_731),
        .rx_clk(Net_732));
	...
	cy_clock_v1_0
		#(.id("ba3bd138-d3be-4a80-831c-715bad98555d"),
		  .source_clock_id(""),
		  .divisor(0),
		  .period("10000000000"),
		  .is_direct(0),
	...
	cy_psoc3_pins_v1_10
		#(.id("de245d7d-7dea-48d7-8368-11dc40ff59d8"),
		  .drive_mode(3'b011),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_sync(1'b1),
	...
	cy_psoc3_pins_v1_10
		#(.id("66a559ba-c051-4371-9e66-f8ed1d8f0e19"),
		  .drive_mode(3'b011),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_sync(1'b1),
	...
	cy_psoc3_pins_v1_10
		#(.id("ee2b83c1-12c6-4432-812b-1f456f11e277"),
		  .drive_mode(3'b011),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_sync(1'b1),
	...
	cy_psoc3_pins_v1_10
		#(.id("99406d35-ddc6-497c-a413-a34918508470"),
		  .drive_mode(3'b011),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_sync(1'b1),
    ...
    Timer_v2_30_5 Timer_Nav (
        ...
        .tc(Net_626),
        .clock(Net_433));
    defparam Timer_Nav.CaptureCount = 2;
    defparam Timer_Nav.CaptureCounterEnabled = 0;
    defparam Timer_Nav.DeviceFamily = "PSoC5";
    defparam Timer_Nav.InterruptOnCapture = 1;
    defparam Timer_Nav.InterruptOnTC = 0;
    defparam Timer_Nav.Resolution = 16;
    defparam Timer_Nav.SiliconRevision = "0";


	cy_clock_v1_0
		#(.id("94740077-e38a-4994-97eb-35e6d0df78c1"),
		  .source_clock_id(""),
		  .divisor(0),
	...
	cy_psoc3_pins_v1_10
		#(.id("1e856b81-2301-4397-a187-7cec30f54249"),
		  .drive_mode(3'b011),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_sync(1'b1),
    ...
    Timer_v2_30_6 Timer_Infrared_0 (
        .reset(Net_490),
        .interrupt(Net_1026),
        .enable(1'b1),
        .trigger(1'b0),
        .capture(Net_1017),
        .capture_out(Net_1029),
        .tc(Net_1030),
        .clock(Net_791));
    defparam Timer_Infrared_0.CaptureCount = 2;
    defparam Timer_Infrared_0.CaptureCounterEnabled = 0;
    defparam Timer_Infrared_0.DeviceFamily = "PSoC5";
    defparam Timer_Infrared_0.InterruptOnCapture = 1;
    defparam Timer_Infrared_0.InterruptOnTC = 0;
    defparam Timer_Infrared_0.Resolution = 24;
    defparam Timer_Infrared_0.SiliconRevision = "0";


	cy_clock_v1_0
		#(.id("f2f6be70-1d3d-4255-a361-82a257cf55c2"),
		  .source_clock_id(""),
		  .divisor(0),
	...
	cy_psoc3_pins_v1_10
		#(.id("f4b90f9f-6888-4a34-b547-e7bc8b9c2c63"),
		  .drive_mode(3'b011),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_sync(1'b1),
    ...
    Timer_v2_30_7 Timer_Infrared_1 (
        .reset(Net_734),
        .interrupt(Net_1124),
        .enable(1'b1),
        .trigger(1'b0),
        ...
        .tc(Net_739),
        .clock(Net_791));
    defparam Timer_Infrared_1.CaptureCount = 2;
    defparam Timer_Infrared_1.CaptureCounterEnabled = 0;
    defparam Timer_Infrared_1.DeviceFamily = "PSoC5";
    defparam Timer_Infrared_1.InterruptOnCapture = 1;
    defparam Timer_Infrared_1.InterruptOnTC = 0;
    defparam Timer_Infrared_1.Resolution = 24;
    defparam Timer_Infrared_1.SiliconRevision = "0";
	...
	cy_psoc3_pins_v1_10
		#(.id("92077f11-cbb4-4705-bb4c-5afe371848cb"),
		  .drive_mode(3'b011),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_sync(1'b1),
    ...
    Timer_v2_30_8 Timer_Infrared_2 (
        .reset(Net_745),
        .interrupt(Net_746),
        .enable(1'b1),
        .trigger(1'b0),
        ...
        .tc(Net_750),
        .clock(Net_791));
    defparam Timer_Infrared_2.CaptureCount = 2;
    defparam Timer_Infrared_2.CaptureCounterEnabled = 0;
    defparam Timer_Infrared_2.DeviceFamily = "PSoC5";
    defparam Timer_Infrared_2.InterruptOnCapture = 1;
    defparam Timer_Infrared_2.InterruptOnTC = 0;
    defparam Timer_Infrared_2.Resolution = 24;
    defparam Timer_Infrared_2.SiliconRevision = "0";
	...
	cy_psoc3_pins_v1_10
		#(.id("f0fac53b-26c6-485e-8c84-fec35960825e"),
		  .drive_mode(3'b011),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_sync(1'b1),
    ...
    Timer_v2_30_9 Timer_Infrared_3 (
        .reset(Net_777),
        .interrupt(Net_1065),
        .enable(1'b1),
        .trigger(1'b0),
        .capture(Net_789),
        .capture_out(Net_1068),
        .tc(Net_1069),
        .clock(Net_791));
    defparam Timer_Infrared_3.CaptureCount = 2;
    defparam Timer_Infrared_3.CaptureCounterEnabled = 0;
    defparam Timer_Infrared_3.DeviceFamily = "PSoC5";
    defparam Timer_Infrared_3.InterruptOnCapture = 1;
    defparam Timer_Infrared_3.InterruptOnTC = 0;
    defparam Timer_Infrared_3.Resolution = 24;
    defparam Timer_Infrared_3.SiliconRevision = "0";
    ...
    CyControlReg_v1_70 Control_Reg (
        .control_1(Net_1092),
        .control_2(Net_1096),
        .control_3(Net_1104),
        .control_0(Net_1116),
    ...
    defparam Control_Reg.NumOutputs = 4;


    assign Net_733 = Net_1092 & Net_1091;


    assign Net_1017 = Net_1116 & Net_616;


    assign Net_744 = Net_1096 & Net_1102;


    assign Net_789 = Net_1104 & Net_1101;
	...
	cy_psoc3_pins_v1_10
		#(.id("e2d1a677-7632-4dfb-9f32-10afd0473291"),
		  .drive_mode(3'b011),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_sync(1'b1),
