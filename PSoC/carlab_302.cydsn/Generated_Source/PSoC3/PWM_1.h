...
#endif /* !defined(PWM_1_PWMUDB_sSTSReg_stsreg__REMOVED) */
#if !defined(PWM_1_PWMUDB_sCTRLReg_ctrlreg__REMOVED)
    #define PWM_1_UseControl 1u
#else
    #define PWM_1_UseControl 0u
#endif /* !defined(PWM_1_PWMUDB_sCTRLReg_ctrlreg__REMOVED) */
...
#define PWM_1_GetInterruptSource() PWM_1_ReadStatusRegister()
    ...
    #define PWM_1_ReadCapture() CY_GET_REG8(PWM_1_CAPTURE_LSB_PTR)
    #if (PWM_1_UseStatus)
...
void    PWM_1_WritePeriod(uint8 period) \
                                     ;
#define PWM_1_ReadPeriod() CY_GET_REG8(PWM_1_PERIOD_LSB_PTR) 
#if (PWM_1_UseOneCompareMode)
    void    PWM_1_WriteCompare(uint8 compare) \
                                          ;
    #define PWM_1_ReadCompare() CY_GET_REG8(PWM_1_COMPARE1_LSB_PTR) 
#else
    void    PWM_1_WriteCompare1(uint8 compare) \
                                           ;
    #define PWM_1_ReadCompare1() CY_GET_REG8(PWM_1_COMPARE1_LSB_PTR) 
    void    PWM_1_WriteCompare2(uint8 compare) \
                                           ;
    #define PWM_1_ReadCompare2() CY_GET_REG8(PWM_1_COMPARE2_LSB_PTR) 
#endif /* (PWM_1_UseOneCompareMode) */
...
**************************************/
#define PWM_1_INIT_PERIOD_VALUE        99u
#define PWM_1_INIT_COMPARE_VALUE1      0u
#define PWM_1_INIT_COMPARE_VALUE2      63u
#define PWM_1_INIT_INTERRUPTS_MODE     ((0u << PWM_1_STATUS_TC_INT_EN_MASK_SHIFT) | \
                                                  (0 << PWM_1_STATUS_CMP2_INT_EN_MASK_SHIFT) | \
                                                  (0 << PWM_1_STATUS_CMP1_INT_EN_MASK_SHIFT ) | \
                                                  (0 << PWM_1_STATUS_KILL_INT_EN_MASK_SHIFT ))
...
******************************** */
   ...
   #define PWM_1_AUX_CONTROLDP0_PTR  ((reg8 *) PWM_1_PWMUDB_sP8_pwmdp_u0__DP_AUX_CTL_REG)
    ...
    /* In Fixed Function Block these bits are in the control blocks control register */
        ...
        #define PWM_1_DEADBAND_COUNT        (*(reg8 *) PWM_1_PWMUDB_sDB3_SyncCtl_dbctrlreg__CONTROL_REG)
        #define PWM_1_DEADBAND_COUNT_PTR     ((reg8 *) PWM_1_PWMUDB_sDB3_SyncCtl_dbctrlreg__CONTROL_REG)
        #define PWM_1_DEADBAND_COUNT_MASK    (0x03u << PWM_1_DEADBAND_COUNT_SHIFT) 
...
#else
    #define PWM_1_STATUS                (*(reg8 *) PWM_1_PWMUDB_sSTSReg_rstSts_stsreg__STATUS_REG )
    #define PWM_1_STATUS_PTR            ((reg8 *) PWM_1_PWMUDB_sSTSReg_rstSts_stsreg__STATUS_REG )
    #define PWM_1_STATUS_MASK           (*(reg8 *) PWM_1_PWMUDB_sSTSReg_rstSts_stsreg__MASK_REG)
    #define PWM_1_STATUS_MASK_PTR       ((reg8 *) PWM_1_PWMUDB_sSTSReg_rstSts_stsreg__MASK_REG)
    #define PWM_1_STATUS_AUX_CTRL       (*(reg8 *) PWM_1_PWMUDB_sSTSReg_rstSts_stsreg__STATUS_AUX_CTL_REG)
    #define PWM_1_CONTROL               (*(reg8 *) PWM_1_PWMUDB_sCTRLReg_SyncCtl_ctrlreg__CONTROL_REG)
    #define PWM_1_CONTROL_PTR           ((reg8 *) PWM_1_PWMUDB_sCTRLReg_SyncCtl_ctrlreg__CONTROL_REG)
