...
void PWM_1_SetCompareMode(uint8 comparemode) 
{
    ...
    #elif (PWM_1_UseControl)
        uint8 comparemode1masked = (comparemode << PWM_1_CTRL_CMPMODE1_SHIFT) & 
                                    PWM_1_CTRL_CMPMODE1_MASK;
        uint8 comparemode2masked = (comparemode << PWM_1_CTRL_CMPMODE2_SHIFT) & 
                                   PWM_1_CTRL_CMPMODE2_MASK;
        /*Clear existing mode */
        PWM_1_CONTROL &= ~(PWM_1_CTRL_CMPMODE1_MASK | PWM_1_CTRL_CMPMODE2_MASK); 
...
void PWM_1_SetCompareMode2(uint8 comparemode) 
{
    ...
    #elif (PWM_1_UseControl)
        uint8 comparemodemasked = (comparemode << PWM_1_CTRL_CMPMODE2_SHIFT) & 
                                             PWM_1_CTRL_CMPMODE2_MASK;
                                   ...
                                   
{
   CY_SET_REG8(PWM_1_COMPARE1_LSB_PTR, compare);
        ...
        CY_SET_REG8(PWM_1_COMPARE2_LSB_PTR, compare+1);
...
void PWM_1_WriteDeadTime(uint8 deadtime) 
{
    /* If using the Dead Band 1-255 mode then just write the register */
        ...
        PWM_1_DEADBAND_COUNT &= ~PWM_1_DEADBAND_COUNT_MASK; 
            /* Set new dead time */
        PWM_1_DEADBAND_COUNT |= (deadtime << PWM_1_DEADBAND_COUNT_SHIFT) & 
