...
void button_left_isr_Start(void)
{
    ...
    /* Set the priority. */
    button_left_isr_SetPriority(button_left_isr_INTC_PRIOR_NUMBER);
...
*   the component has been started use button_left_isr_StartEx instead.
*
*
* Parameters:
*   address: Address of the ISR to set in the interrupt vector table.
...
void button_left_isr_SetVector(cyisraddress address) 
{
    ...
    ramVectorTable[CYINT_IRQ_BASE + button_left_isr__INTC_NUMBER] = address;
}
...
cyisraddress button_left_isr_GetVector(void) 
{
    ...
    return ramVectorTable[CYINT_IRQ_BASE + button_left_isr__INTC_NUMBER];
}
...
********************************************************************************
* Summary:
*   Sets the Priority of the Interrupt. Note calling button_left_isr_Start
*   or button_left_isr_StartEx will override any effect this method would have had. 
*	This method should only be called after button_left_isr_Start or 
*	button_left_isr_StartEx has been called. To set the initial
...
{
    *button_left_isr_INTC_PRIOR = priority << 5;
}
...
uint8 button_left_isr_GetPriority(void) 
{
    ...
    priority = *button_left_isr_INTC_PRIOR >> 5;
...
uint8 button_left_isr_GetState(void) 
{
    ...
    return (*button_left_isr_INTC_SET_EN & button_left_isr__INTC_MASK) ? 1:0;
}
