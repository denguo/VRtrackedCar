...
/*******************************************************************************
* Function Name: Clock_Infrared_Start
********************************************************************************
* Summary:
...
void Clock_Infrared_Start(void) 
{
    ...
    Clock_Infrared_CLKEN |= Clock_Infrared_CLKEN_MASK;
}


/*******************************************************************************
* Function Name: Clock_Infrared_Stop
********************************************************************************
* Summary:
...
/*******************************************************************************
* Function Name: Clock_Infrared_StopBlock
********************************************************************************
* Summary:
...
{
    if (Clock_Infrared_CLKEN & Clock_Infrared_CLKEN_MASK)
    {
        ...
        CLK_DIST_AMASK = Clock_Infrared_CLKEN_MASK;
        CLK_DIST_DMASK = 0x00u;
#else
        CLK_DIST_DMASK = Clock_Infrared_CLKEN_MASK;
        ...
        oldDivider = CY_GET_REG16(Clock_Infrared_DIV_PTR);
        ...
        CLK_DIST_LD = 0x00u;
        CY_SET_REG16(Clock_Infrared_DIV_PTR, oldDivider);
#endif
    }
}
#endif
...
/*******************************************************************************
* Function Name: Clock_Infrared_StandbyPower
********************************************************************************
* Summary:
...
void Clock_Infrared_StandbyPower(uint8 state) 
{
    if(state == 0)
    {
        Clock_Infrared_CLKSTBY &= ~Clock_Infrared_CLKSTBY_MASK;
    }
    else
    {
        Clock_Infrared_CLKSTBY |= Clock_Infrared_CLKSTBY_MASK;
...
/*******************************************************************************
* Function Name: Clock_Infrared_SetDividerRegister
********************************************************************************
* Summary:
...
*
*******************************************************************************/
void Clock_Infrared_SetDividerRegister(uint16 clkDivider, uint8 restart) 
{
    uint8 enabled;

    uint8 currSrc = Clock_Infrared_GetSourceRegister();
    uint16 oldDivider = Clock_Infrared_GetDividerRegister();

    if (clkDivider != oldDivider)
    {
        enabled = Clock_Infrared_CLKEN & Clock_Infrared_CLKEN_MASK;
        ...
        if (currSrc == CYCLK_SRC_SEL_CLK_SYNC_D && (oldDivider == 0 || clkDivider == 0))
        {
            ...
            if (oldDivider == 0 && clkDivider != 0)
            {
                ...
                CY_SET_REG16(Clock_Infrared_DIV_PTR, clkDivider);
                Clock_Infrared_MOD_SRC &= ~CYCLK_SSS;
            }
            else
            {
...
/*******************************************************************************
* Function Name: Clock_Infrared_GetDividerRegister
********************************************************************************
* Summary:
...
{
    return CY_GET_REG16(Clock_Infrared_DIV_PTR);
}


/*******************************************************************************
* Function Name: Clock_Infrared_SetModeRegister
********************************************************************************
* Summary:
...
*
*******************************************************************************/
void Clock_Infrared_SetModeRegister(uint8 clkMode) 
{
    Clock_Infrared_MOD_SRC |= clkMode & Clock_Infrared_MODE_MASK;
}


/*******************************************************************************
* Function Name: Clock_Infrared_ClearModeRegister
********************************************************************************
* Summary:
...
*
*******************************************************************************/
void Clock_Infrared_ClearModeRegister(uint8 clkMode) 
{
    Clock_Infrared_MOD_SRC &= ~clkMode | ~Clock_Infrared_MODE_MASK;
}
...
/*******************************************************************************
* Function Name: Clock_Infrared_GetModeRegister
********************************************************************************
* Summary:
...
{
    return Clock_Infrared_MOD_SRC & Clock_Infrared_MODE_MASK;
}


/*******************************************************************************
* Function Name: Clock_Infrared_SetSourceRegister
********************************************************************************
* Summary:
...
{
    uint16 currDiv = Clock_Infrared_GetDividerRegister();
    uint8 oldSrc = Clock_Infrared_GetSourceRegister();
    ...
    if (oldSrc != CYCLK_SRC_SEL_CLK_SYNC_D && clkSource == CYCLK_SRC_SEL_CLK_SYNC_D && currDiv == 0)
    {
        ...
        Clock_Infrared_MOD_SRC |= CYCLK_SSS;
        Clock_Infrared_MOD_SRC =
            (Clock_Infrared_MOD_SRC & ~Clock_Infrared_SRC_SEL_MSK) | clkSource;
    }
...
/*******************************************************************************
* Function Name: Clock_Infrared_GetSourceRegister
********************************************************************************
* Summary:
...
{
    return Clock_Infrared_MOD_SRC & Clock_Infrared_SRC_SEL_MSK;
}
...
/*******************************************************************************
* Function Name: Clock_Infrared_SetPhaseRegister
********************************************************************************
* Summary:
...
{
    Clock_Infrared_PHASE = clkPhase & Clock_Infrared_PHASE_MASK;
}


/*******************************************************************************
* Function Name: Clock_Infrared_GetPhase
********************************************************************************
* Summary:
...
{
    return Clock_Infrared_PHASE & Clock_Infrared_PHASE_MASK;
}
