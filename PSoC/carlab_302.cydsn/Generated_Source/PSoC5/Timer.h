 ...
 *************************************************************************/
typedef struct Timer_backupStruct
{
...
#define Timer_INIT_CAPTURE_MODE       (1u << Timer_CTRL_CAP_MODE_SHIFT)
#define Timer_INIT_TRIGGER_MODE       (0u << Timer_CTRL_TRIG_MODE_SHIFT)
#if (Timer_UsingFixedFunction)
    #define Timer_INIT_INTERRUPT_MODE ((0u << Timer_STATUS_TC_INT_MASK_SHIFT) | \
                                                  (1 << Timer_STATUS_CAPTURE_INT_MASK_SHIFT))
#else
    #define Timer_INIT_INTERRUPT_MODE ((0u << Timer_STATUS_TC_INT_MASK_SHIFT) | \
                                                 (1 << Timer_STATUS_CAPTURE_INT_MASK_SHIFT) | \
                                                 (0 << Timer_STATUS_FIFOFULL_INT_MASK_SHIFT))
#endif /* (Timer_UsingFixedFunction) */
#define Timer_INIT_CAPTURE_COUNT      (2u)
#define Timer_INIT_INT_CAPTURE_COUNT  ((1u - 1) << Timer_CTRL_INTCNT_SHIFT)
...
***************************************/
    ...
    ***************************************/
    ...
    #define Timer_CTRL_ENABLE                        (0x01u << Timer_CTRL_ENABLE_SHIFT)

    /* Control2 Register Bit Masks */
    /* As defined in Register Map, Part of the TMRX_CFG1 register */
    #define Timer_CTRL2_IRQ_SEL_SHIFT                 0x00u
    #define Timer_CTRL2_IRQ_SEL                      (0x01u << Timer_CTRL2_IRQ_SEL_SHIFT)

    #if (CY_PSOC5A)
        /* Use CFG1 Mode bits to set run mode */
        /* As defined by Verilog Implementation */
        #define Timer_CTRL_MODE_SHIFT                     0x01u
        #define Timer_CTRL_MODE_MASK                     (0x07u << Timer_CTRL_MODE_SHIFT)
    #endif /* (CY_PSOC5A) */
    #if (CY_PSOC3 || CY_PSOC5LP)
        ...
        #define Timer_CTRL_RCOD_MASK  (0x03u << Timer_CTRL_RCOD_SHIFT) /* ROD and COD bit masks */
        #define Timer_CTRL_ENBL_MASK  (0x80u << Timer_CTRL_ENBL_SHIFT) /* HW_EN bit mask */
        #define Timer_CTRL_MODE_MASK  (0x03u << Timer_CTRL_MODE_SHIFT) /* Run mode bit mask */

        #define Timer_CTRL_RCOD       (0x03u << Timer_CTRL_RCOD_SHIFT)
        #define Timer_CTRL_ENBL       (0x80u << Timer_CTRL_ENBL_SHIFT)
    #endif /* (CY_PSOC3 || CY_PSOC5LP) */

    /*RT1 Synch Constants: Applicable for PSoC3 and PSoC5LP */
    #define Timer_RT1_SHIFT                       0x04u
    /* Sync TC and CMP bit masks */
    #define Timer_RT1_MASK                        (0x03u << Timer_RT1_SHIFT)
    #define Timer_SYNC                            (0x03u << Timer_RT1_SHIFT)
    #define Timer_SYNCDSI_SHIFT                   0x00u
    /* Sync all DSI inputs with Mask  */
    #define Timer_SYNCDSI_MASK                    (0x0Fu << Timer_SYNCDSI_SHIFT)
    /* Sync all DSI inputs */
    #define Timer_SYNCDSI_EN                      (0x0Fu << Timer_SYNCDSI_SHIFT)

    #define Timer_CTRL_MODE_PULSEWIDTH            (0x01u << Timer_CTRL_MODE_SHIFT)
    #define Timer_CTRL_MODE_PERIOD                (0x02u << Timer_CTRL_MODE_SHIFT)
    #define Timer_CTRL_MODE_CONTINUOUS            (0x00u << Timer_CTRL_MODE_SHIFT)
    ...
    /* As defined in Register Map, part of TMRX_SR0 register */
    #define Timer_STATUS_TC_INT_MASK_SHIFT        (Timer_STATUS_TC_SHIFT - 4)
    /* As defined in Register Map, part of TMRX_SR0 register, Shared with Compare Status */
    #define Timer_STATUS_CAPTURE_INT_MASK_SHIFT   (Timer_STATUS_CAPTURE_SHIFT - 4)

    /* Status Register Bit Masks */
    #define Timer_STATUS_TC                       (0x01u << Timer_STATUS_TC_SHIFT)
    #define Timer_STATUS_CAPTURE                  (0x01u << Timer_STATUS_CAPTURE_SHIFT)
    /* Interrupt Enable Bit-Mask for interrupt on TC */
    #define Timer_STATUS_TC_INT_MASK              (0x01u << Timer_STATUS_TC_INT_MASK_SHIFT)
    /* Interrupt Enable Bit-Mask for interrupt on Capture */
    #define Timer_STATUS_CAPTURE_INT_MASK         (0x01u << Timer_STATUS_CAPTURE_INT_MASK_SHIFT)
    ...
    ***************************************/
    ...
    /* Control Register Bit Masks */
    #define Timer_CTRL_INTCNT_MASK               (0x03u << Timer_CTRL_INTCNT_SHIFT)
    #define Timer_CTRL_TRIG_MODE_MASK            (0x03u << Timer_CTRL_TRIG_MODE_SHIFT)
    #define Timer_CTRL_TRIG_EN                   (0x01u << Timer_CTRL_TRIG_EN_SHIFT)
    #define Timer_CTRL_CAP_MODE_MASK             (0x03u << Timer_CTRL_CAP_MODE_SHIFT)
    #define Timer_CTRL_ENABLE                    (0x01u << Timer_CTRL_ENABLE_SHIFT)
    ...
    #define Timer_STATUS_TC_INT_MASK             (0x01u << Timer_STATUS_TC_SHIFT)
    /* Interrupt Enable Bit-Mask */
    #define Timer_STATUS_CAPTURE_INT_MASK        (0x01u << Timer_STATUS_CAPTURE_SHIFT)
    /* NOT-Sticky FIFO Full Bit-Mask */
    #define Timer_STATUS_FIFOFULL                (0x01u << Timer_STATUS_FIFOFULL_SHIFT)
    /* NOT-Sticky FIFO Not Empty Bit-Mask */
    #define Timer_STATUS_FIFONEMP                (0x01u << Timer_STATUS_FIFONEMP_SHIFT)
    /* Interrupt Enable Bit-Mask */
    #define Timer_STATUS_FIFOFULL_INT_MASK       (0x01u << Timer_STATUS_FIFOFULL_SHIFT)
