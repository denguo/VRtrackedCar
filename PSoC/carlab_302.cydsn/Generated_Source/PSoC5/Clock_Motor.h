...
void Clock_Motor_SetDividerRegister(uint16 clkDivider, uint8 reset) ;
...
#define Clock_Motor_SetDivider(clkDivider)         Clock_Motor_SetDividerRegister(clkDivider, 1)
#define Clock_Motor_SetDividerValue(clkDivider)    Clock_Motor_SetDividerRegister((clkDivider) - 1, 1)
...
#define Clock_Motor_SetPhaseValue(clkPhase)        Clock_Motor_SetPhaseRegister((clkPhase) + 1)
#endif
