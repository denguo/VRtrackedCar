...
{
    CY_SET_REG8(PWM_Motor_COUNTER_LSB_PTR, counter);
}
...
uint8 PWM_Motor_ReadCounter(void) 
{
    ...
    return (CY_GET_REG8(PWM_Motor_CAPTURE_LSB_PTR));
}
...
void PWM_Motor_WritePeriod(uint8 period) 
{
    ...
    #else
        CY_SET_REG8(PWM_Motor_PERIOD_LSB_PTR, period);
    #endif /* (PWM_Motor_UsingFixedFunction) */
}
...
{
   CY_SET_REG8(PWM_Motor_COMPARE1_LSB_PTR, compare);
   #if (PWM_Motor_PWMMode == PWM_Motor__B_PWM__DITHER)
        CY_SET_REG8(PWM_Motor_COMPARE2_LSB_PTR, compare+1);
                                    ...
                                    
{
    ...
    #else
        CY_SET_REG8(PWM_Motor_COMPARE2_LSB_PTR, compare);
    #endif /* (PWM_Motor_UsingFixedFunction) */
}
#endif /* UseOneCompareMode */
